...
module EF_PSRAM_CTRL_wb (
    ...
    PSRAM_READER MR (
        ...
        .rd(mr_rd & qpi_mode_done),
        //.size(size), Always read a word
        .size(3'd4),
        .done(mr_done),
        .line(dat_o),

        .qpi_mode(qpi_mode_done),
    ...
    assign sck  = qpi_mode_done ?  wb_we ? mw_sck  : mr_sck : qpi_sck;
    assign ce_n = qpi_mode_done ?  wb_we ? mw_ce_n : mr_ce_n : qpi_ce_n;
    assign dout = qpi_mode_done ?  wb_we ? mw_dout : mr_dout : qpi_dout;
